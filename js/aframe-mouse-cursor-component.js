    ...
    (function(module, exports, __webpack_require__) {
	  ...
	  ==============================*/
            ...
            _attachEventListeners: function _attachEventListeners() {
                ...
                this._canvasSize = false;
                window.addEventListener('resize', this._getCanvasPos.bind(this));
                document.addEventListener('scroll', this._getCanvasPos.bind(this));
                this._getCanvasPos();
                sceneEl.addEventListener('enter-vr', this._onEnterVR.bind(this));
                sceneEl.addEventListener('exit-vr', this._onExitVR.bind(this));
                canvas.addEventListener('mousedown', this._onDown.bind(this));
                canvas.addEventListener('mousemove', this._onMouseMove.bind(this));
                canvas.addEventListener('mouseup', this._onRelease.bind(this));
                canvas.addEventListener('mouseout', this._onRelease.bind(this));
                canvas.addEventListener('touchstart', this._onDown.bind(this));
                canvas.addEventListener('touchmove', this._onTouchMove.bind(this));
                canvas.addEventListener('touchend', this._onRelease.bind(this));
                canvas.addEventListener('click', this._onClick.bind(this));
                el.addEventListener('componentchanged', this._onComponentChanged.bind(this));
            },
