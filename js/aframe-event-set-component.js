	      ...
	      for (propName in data) {
	        ...
	        AFRAME.utils.entity.setComponentProperty.call(this, targetEl, propName, data[propName]);
	         ...
	         if (propName === '_func') { 
	         	...
	         	eval(data[propName]);
	         	//targetEl.object3D.rotation.y += 45;
	         	/*if(window.settings[data[propName]])
	         		if(data["_funcData"])	         		
	         		window.settings[data[propName]](data["_funcData"]);	//should set the function before call it*/
	         	//console.log("roooo"+data[propName]);
	         }
